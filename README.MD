...
## install
  - pip install -i https://pypi.org/simple -U deep_training>=0.1.7 cpm_kernels transformers>=4.26.1 deepspeed
...
### int高效训练方式
1.p-tuning-v2   使用chatglm-6b-int4 or chatglm-6b-int8  或者 
