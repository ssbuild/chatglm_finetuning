##  
    4月12日 deep_training 0.1.2.post0 fix load_in_8bit in lora v1 , lova v2 .
...
## int高效训练方式
   ...
   2. lora int8     配置文件quantization_bit=0，使用官方标准float 16权重文件，修改modes.py load_in_8bit = True 修改data_utils.py 对应with_lora=True
